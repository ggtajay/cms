...
const ViewStudent = () => {
  ...
  const handleResendCredentials = async () => {
    if (!window.confirm('Are you sure you want to resend credentials? This will generate a new password and email it to the student.')) return
    
    const loadingToast = toast.loading('Resending credentials...')
    try {
      const res = await axios.post(`/api/students/${id}/resend-credentials`, {}, config)
